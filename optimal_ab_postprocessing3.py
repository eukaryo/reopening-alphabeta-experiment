...
SOURCE_DIR = "./optimal_ab_postprocess2/"
DEST_DIR = "./optimal_ab_postprocess3/"
...
def execute(disccount):
    ...
    filename = f"optimal_ab_table_all_{disccount}.txt"
    command = f"./reopening optimal-ab-postprocess3 {SOURCE_DIR}/{filename} {DEST_DIR}/{filename}"
